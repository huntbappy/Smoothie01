...
const SmoothieLogo: React.FC<{ className?: string }> = ({ className }) => (
  <svg viewBox="0 0 150 180" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Smoothie Liquid - Pink/Peach */}
    <path d="M53 70 Q75 55 97 70 V127 H53 Z" fill="#e99695" />
    
    {/* Bubbles - Dark Red/Brown */}
    <circle cx="62" cy="80" r="3" fill="#8c3a3a" opacity="0.6" />
    <circle cx="88" cy="90" r="3.5" fill="#8c3a3a" opacity="0.6" />
    <circle cx="75" cy="105" r="2.5" fill="#8c3a3a" opacity="0.6" />
    <circle cx="68" cy="120" r="2" fill="#8c3a3a" opacity="0.6" />
    <circle cx="82" cy="117" r="2.5" fill="#8c3a3a" opacity="0.6" />
    
    {/* Banner Ribbon - Yellow */}
    <path d="M15 90 H135 V115 H15 L20 102.5 L15 90" fill="#facc15" stroke="#000000" strokeWidth="2.5" />
    <path d="M135 90 L140 102.5 L135 115" fill="#facc15" stroke="#000000" strokeWidth="2.5" />
